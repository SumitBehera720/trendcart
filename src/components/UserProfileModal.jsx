...
import { X, User, Mail, Phone, MapPin, Lock, Camera, History, LogOut, Edit, Save, Check, Truck, Eye, EyeOff } from 'lucide-react';
...
export default function UserProfileModal({ 
  ...
  const handleResetPasswordSubmit = (e) => {
    ...
    localStorage.setItem('trendcart_users', JSON.stringify(updatedUsers));
  ...
  const getMembershipStatus = () => {
    ...
    if (!currentUser.email) {
      return {
        tier: 'TrendCart Member',
        badge: 'TRENDCART MEMBER',
        class: 'trendcart',
        color: '#9ca3af',
        count: 0,
            ...
            <div className="tracking-modal-header">
              <div>
                <h2 className="tracking-modal-title">
                  {currentUser ? 'TrendCart Profile' : activeTab === 'forgot' ? 'Reset Gate' : activeTab === 'reset' ? 'Set Password' : 'Join TrendCart'}
                </h2>
              ...
              <AnimatePresence mode="wait">
                    ...
                    {activeTab === 'login' && (
                      <form onSubmit={handleLoginSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        <div className="rzp-input-group">
                          ...
                          <div style={{ position: 'relative' }}>
                            <input 
                              type="email" 
                              className="rzp-input" 
                              placeholder="demo: demo@trendcart.com"
                        ...
                        <div className="mono" style={{ fontSize: '0.65rem', textAlign: 'center', color: 'var(--text-grey)', marginTop: '12px' }}>
                          Tip: Use email <strong style={{ color: 'var(--accent-raw)' }}>demo@trendcart.com</strong> & password <strong style={{ color: 'var(--accent-raw)' }}>smart</strong> for instant preview testing.
                        </div>
                      </form>
                    )}
                        ...
                        <div className="rzp-input-group">
                          ...
                          <div style={{ position: 'relative' }}>
                            <input 
                              type="email" 
                              className="rzp-input" 
                              placeholder="e.g. demo@trendcart.com"
                              style={{ width: '100%', paddingLeft: '40px' }}
                              value={email}
                              onChange={e => setEmail(e.target.value)}
                              required
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        ...
                        <form onSubmit={handleForgotSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                          ...
                          {!resetRequested ? (
                            ...
                            <div style={{ backgroundColor: 'rgba(6,182,212,0.03)', border: '1px dashed rgba(6,182,212,0.25)', padding: '18px', borderRadius: '4px', textAlign: 'center' }}>
                              <div className="mono" style={{ fontSize: '0.65rem', color: 'var(--accent-raw)', fontWeight: 800, marginBottom: '6px' }}>[TRENDCART EMAIL GATEWAY]</div>
                ...
                {currentUser && (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', gap: '10px', alignItems: 'center', backgroundColor: 'rgba(6,182,212,0.03)', border: '1px dashed rgba(6,182,212,0.2)', padding: '12px 16px', borderRadius: '4px', marginBottom: '24px', flexWrap: 'wrap' }}>
                      ...
                      {currentUser?.email === 'admin@trendcart.com' && (
                        <button 
                          onClick={onOpenAdmin}
