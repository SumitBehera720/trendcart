...
export default function OrderTrackingModal({ 
  ...
  const timelineSteps = [
    { title: 'Order Confirmed', desc: 'Order received and secure payment verified.', icon: ShieldCheck },
    { title: 'Processing Order', desc: 'Quality inspection and packaging checked.', icon: Package },
    { title: 'Dispatched', desc: 'Handed over to logistics carrier partner.', icon: Truck },
    { title: 'In Transit', desc: 'Shipment is on the way to your destination.', icon: ArrowRight },
    { title: 'Delivered', desc: 'Shipment successfully delivered.', icon: Check }
  ];
        ...
        <>
          ...
          >
            <div className="tracking-modal-header">
              <div>
                <h2 className="tracking-modal-title">Track Your Order</h2>
                {activeOrder && (
                ...
                {!activeOrder ? (
                  ...
                  >
                    <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                      ...
                      <h3 style={{ fontSize: '1.1rem', color: 'var(--text-light)', fontFamily: 'var(--font-heading)' }}>RETRIEVE TRACKING TIMELINE</h3>
                      <p style={{ fontSize: '0.8rem', color: 'var(--text-grey)', marginTop: '8px', lineHeight: '1.4' }}>
                        Enter your 8-character secure transaction code (e.g., <strong style={{ color: 'var(--accent-raw)' }}>TC-123456</strong>) to inspect dispatch and transit logs.
                      </p>
                    </div>
