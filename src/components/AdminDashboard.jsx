...
export default function AdminDashboard({ currentUser, onClose }) {
  ...
  const [formData, setFormData] = useState({
    id: '', name: '', tagline: '', price: '', category: 'clothing',
    image: '', description: ''
  });
  ...
  const resetForm = () => {
    setFormData({ id: '', name: '', tagline: '', price: '', category: 'clothing', image: '', description: '' });
    setIsEditing(false);
    setEditingId(null);
  };
        ...
        <div style={{ backgroundColor: 'var(--bg-card)', padding: '24px', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '4px', position: 'sticky', top: '100px' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div className="rzp-input-group">
              ...
              <input type="text" name="id" value={formData.id} onChange={handleInputChange} className="rzp-input" required disabled={isEditing} placeholder="e.g. TC-CLO-005" />
            </div>
